...
class AnimalsApp extends StatefulWidget {
  @override
  _AnimalsAppState createState() => _AnimalsAppState();
}
...
class _AnimalsAppState extends State<AnimalsApp> {
  ...
  final animalKey = GlobalKey<AnimalsQuizState>();
  @override
  Widget build(BuildContext context) {
    Map<String, dynamic> currentAnimal =
        Provider.of<QuizProvider>(context, listen: false).animal;
...
class RightAnswer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool rightAnswer =
        Provider.of<QuizProvider>(context, listen: false).rightAnswerAnimal;
    return Container(
      alignment: Alignment.center,
      child: rightAnswer
