...
class ShapesApp extends StatefulWidget {
  @override
  _ShapesAppState createState() => _ShapesAppState();
}

/// An example that demonstrates the basic functionality of the
/// SpeechToText plugin for using the speech recognition capability
/// of the underlying platform.
class _ShapesAppState extends State<ShapesApp> {
  ...
  final shapeKey = GlobalKey<ShapesQuizState>();
  @override
...
class RightAnswer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool rightAnswer =
        Provider.of<QuizProvider>(context, listen: false).rightAnswerShape;
    return Container(
      alignment: Alignment.center,
      child: rightAnswer
