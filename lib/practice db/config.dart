...
const activityAdd = url + "activityAdd";
const MySonsGet = url + "MySonsGet";
const getTeacherData = url + "teachers/";
const updateTeacherPhone = "${url}updateTeacherPhone";
const getActiviies = url + "activities";
const updateTeacherImage = url + "updateTeacherImage";
const getMyChildrenMedicine = url + "medicinesTeacher/";
//          ***********Mom
...
const medicineAdd = url + "medicineAdd";
const updateMomImage = url + "updateMomImage";
const getMySonsMedicine = url + "medicines/";
//       ----child----
